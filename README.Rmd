...
The `znorm` function applies traditional Z-score normalization. It computes the
mean and standard deviation of the input data and offers built-in functions for
denormalizing and calculating Z-score-based densities.
